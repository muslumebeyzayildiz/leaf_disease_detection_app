import 'package:domates/pages/gallery.dart';
import 'package:domates/pages/egitim.dart';
import 'package:domates/pages/camera.dart';
import 'package:domates/pages/grafik.dart';
import 'package:domates/services/authentication/loginPage.dart';
import 'package:domates/pages/result.dart';
import 'package:domates/services/authentication/signUp.dart';
import 'package:domates/views/BahceSerasi_view.dart';
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  static  final List<Widget> _pages = <Widget>[
    ...
    //kamera(),
    galeri(),
    TespitGecmisiSayfasi(),
    HastalikIstatistikleriSayfasi(),
    FirestorePage(),
